...
const /**Node Element */ $savedRecipeContainer = document.querySelector("[data-saved-recipe-container]");

$savedRecipeContainer.innerHTML = `
<h2 class="headline-small section-title">All Saved Recipes</h2>
`;
const /**Node Element */ $gridList = document.createElement("div");
...
if (savedRecipes.length) {
    ...
    $savedRecipeContainer.innerHTML += `<p className="body-large">You don't saved any recipes yet</p>`;
}
